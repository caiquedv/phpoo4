...
class aPagarForm extends Page
{
    ...
    public function __construct()
    {
        ...
        $this->form = new FormWrapper(new Form('form_pagar'));
        ...
        $this->form->addField('Emissão',    $emissao, '20%');
        $this->form->addField('Vencimento', $vencimento, '20%');
        $this->form->addField('Empresa',    $empresa, '30%');
        $this->form->addField('Valor', $valor, '20%');
