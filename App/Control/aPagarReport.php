 ...
 * Relatório de contas
 */
class aPagarReport extends Page
{
    ...
    public function __construct()
    {
        ...
        $this->form = new FormWrapper(new Form('form_relat_pagar'));
        $this->form->setTitle('Relatório de contas a Pagar');
    ...
    public function onGera()
    {
        ...
        $template = $twig->loadTemplate('pagar_report.html');
        ...
        try
        {
            ...
            $repositorio = new Repository('Pagar');
